...
function insertArticle($article){
    global $db_default_connection; // dans une fonction on accéss que a $artcile normalement grace a global $db_default_connection; sa me débloque les accés a toutes la bd//
